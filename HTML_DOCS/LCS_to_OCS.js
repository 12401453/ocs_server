...
const chu_fuzzy_search_map = {
  ...
  "e" : "е",
  "c" : "с",
  //!!Not the same as the deep-clean in converting ы to ъі; People who are looking for *ьji will likely type <ьи> instead, whereas people looking for *y will definitely type *ы. The occurrences of <ы> for *y in Supr. mess this up, but I have a suspicion those are mistakes (need to check and then correct)
  "ы" : "ъі",
  "ѵ" : "у",
  "Ꙃ" : "ѕ",
  "Ћ" : "ꙉ",
...
const cleanWord = (dirty_word, cleaning_map) => {
  ...
  for(const key in cleaning_map) {
      cleaned_word = cleaned_word.replaceAll(key, cleaning_map[key]);
  }
  return cleaned_word;
};