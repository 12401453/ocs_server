//compile: clang++ -std=c++20 chu_words_sqlite.cpp -lsqlite3 -licuuc -licudata -licui18n -o chu_words_sqlite
#include <iostream>
#include <sqlite3.h>
#include <string>
#include <sstream>
